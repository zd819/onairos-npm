      ...
      >
        ...
        >
            <div className="relative px-5 py-4 border-b border-white/10 bg-white/5 flex-shrink-0">
              ...
              {isMobile && (
                <div className="mt-3 flex items-start gap-2 bg-yellow-500/10 border border-yellow-500/20 rounded-2xl px-3 py-2">
                  <svg
                  ...
                  <p className="text-xs leading-relaxed text-yellow-200/90">
                    <strong className="font-semibold text-yellow-100">Pro tip:</strong>{' '}
                    We recommend connecting via laptop or desktop for an easier experience!
                  </p>
                </div>
              )}
